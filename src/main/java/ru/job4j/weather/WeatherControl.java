...
public class WeatherControl {
    ...
    public Mono<Weather> getWithMaxTemp() {
        return weathers.findWithMaxTemp();
    }

    @GetMapping(value = "/cityGreatThen/{temp}", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public Flux<Weather> getCityGreaterThan(@PathVariable int temp) {
        return weathers.findGreaterThan(temp);
    }
}
